...
cfg.lbox = 355.11 #Mpc (not h^-1); MDR1 = 1420.0 (=1 h^-1 Gpc), Bolshoi = 355.11 (=250 h^-1 Mpc), DOVE = 100.0
cfg.interloper_dR = 2.5 #in units of cluster virial radius
cfg.interloper_dV = 2.0 #in units of cluster velocity dispersion
cfg.outfile = './bolshoi_orbits.hdf5' #output file
cfg.treedir = '/home/kaoman/CT_Bolshoi_Output/tree/' #location of consistent-trees tree files
cfg.scalefile = './bolshoi_scales.txt' #list of simulation output numbers (col 1) scale factors (col 2)
cfg.skipsnaps = 0 #skip snapshots at end to make high-z catalog
cfg.ncpu = 1

#PARAMETERS BELOW FOR PDFS.PY ONLY
pdf_cfg.resolution_cut = 1.2411E10 #Msun (not h^-1); MDR1 = 10^11.9, Bolshoi=10^11.9/64, bolshoi particle is 1.93E8 Msun (physical), dove particle is 8.8E6 Msun (physical) -> DOVE = 10^8.75
...
pdf_cfg.pdfsfile = './bolshoi_pdfs.hdf5'
