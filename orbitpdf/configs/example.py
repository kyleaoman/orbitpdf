...
pdfcfg.pdf_m_min_satellite = np.power(10, [9., 9.5, 10., 10.5, 11.]) * U.Msun
# lower bin edges for satellite mass
pdfcfg.pdf_m_max_satellite = np.power(10, [9.5, 10., 10.5, 11., 11.5]) * U.Msun
# upper bin edges for satellite mass
pdfcfg.pdf_m_min_cluster = np.power(10, [13., 14.]) * U.Msun  # lower bin edges
# for cluster mass
pdfcfg.pdf_m_max_cluster = np.power(10, [14., 15.]) * U.Msun  # upper bin edges
# for cluster mass
